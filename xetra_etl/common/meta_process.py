...
class MetaProcess():
    ...
    def return_date_list(first_date: str, meta_key: str, s3_bucket_meta: S3BucketConnector):
        ...
        preocessed dates in the meta file
        
        :param first_date: thte earliest date Xetra data schould be processed
        :paramm meta_key: key of the meta file on the S3 bucket
        :param s3_bucket_meta: S3BucketConnector for the bucket with the meta file
