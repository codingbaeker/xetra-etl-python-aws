...
class XetraSourceConfig(NamedTuple):
    ...
    src_col_min_price: column name for minimum price in soure
...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_min_price: column name for minimum price intarget
    ...
    trg_col_ch_prev_clos: column name for change to prevous day´s closing price in target
...
class XetraETL():
    ...
    def extract(self):
        """
        Read the source data and concatenates them to one Pnadas DataFrame
