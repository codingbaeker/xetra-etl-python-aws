...
from xetra_etl.transformers.xetra_transformer import XetraETL, XetraSourceConfig, XetraTargetConfig
...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-project-int-test-src'
        self.s3_bucket_name_trg = 'xetra-project-int-test-trg'
